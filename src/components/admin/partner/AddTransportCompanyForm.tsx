...
export function AddTransportCompanyForm({ partnerId }: { partnerId: string }) {
  ...
  return (
    <form action={action} className="flex flex-wrap items-center gap-2 mt-3">
      <input name="name" type="text" placeholder="Транспортная компания" className="admin-form-input text-sm w-56" />

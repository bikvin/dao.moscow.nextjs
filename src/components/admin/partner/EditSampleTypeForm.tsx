...
import { updateSampleType } from "@/actions/partner/sampleTypes";
import { SubItemFormState } from "@/actions/partner/PartnerFormState";
import { SampleType } from "@prisma/client";
import FormButton from "@/components/common/formButton/formButton";

export function EditSampleTypeForm({ sampleType }: { sampleType: SampleType }) {
  const boundAction = updateSampleType.bind(null, sampleType.id);

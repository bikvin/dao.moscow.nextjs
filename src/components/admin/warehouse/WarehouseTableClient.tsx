  ...
  return (
    <>
      ...
      <div className="sticky top-0 bg-white z-10">
        {/* Group headers */}
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr_2fr_80px] gap-2 px-3 text-xs text-slate-400">
          <div />
        ...
        {/* Column headers */}
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr_2fr_80px] gap-2 px-3 pb-2 text-sm text-slate-400 border-b">
          <div>Товар</div>
      ...
      {/* Footer totals */}
      <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_1fr_2fr_80px] gap-2 py-2 px-3 mt-16 border-t font-medium text-slate-400">
        <div>Итого</div>

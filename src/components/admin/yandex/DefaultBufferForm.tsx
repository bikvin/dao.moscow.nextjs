...
import { saveDefaultBuffer } from "@/actions/yandex/saveDefaultBuffer";

export function DefaultBufferForm({ current }: { current: number }) {
  const [formState, action] = useFormState(saveDefaultBuffer, {});

...
import { saveDefaultDivisor } from "@/actions/yandex/saveDefaultDivisor";

export function DefaultDivisorForm({ current }: { current: number | null }) {
  const [formState, action] = useFormState(saveDefaultDivisor, {});

...
export default async function YandexSyncHistoryPage({
  searchParams,
}: {
  ...
  const [logs, total] = await Promise.all([
    db.yandexSyncLog.findMany({
      orderBy: { createdAt: "desc" },
      skip: (currentPage - 1) * PAGE_SIZE,
      take: PAGE_SIZE,
    }),
    db.yandexSyncLog.count(),
  ]);
    ...
    <>
      ...
      <div className="max-w-screen-lg mx-auto">
        <div className="w-[90%] md:w-2/3 mx-auto">
          <h1 className="admin-form-header mt-10">История синхронизаций</h1>
          ...
          <Pagination
            ...
            basePath="/admin/yandex/sync-history"

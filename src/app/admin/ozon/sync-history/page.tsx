...
export default async function OzonSyncHistoryPage({
  searchParams,
}: {
  ...
  const [logs, total] = await Promise.all([
    db.ozonSyncLog.findMany({
      orderBy: { createdAt: "desc" },
      skip: (currentPage - 1) * PAGE_SIZE,
      take: PAGE_SIZE,
    }),
    db.ozonSyncLog.count(),
  ]);
    ...
    <>
      ...
      <div className="max-w-screen-lg mx-auto">
        <div className="w-[90%] md:w-2/3 mx-auto">
          <h1 className="admin-form-header mt-10">История синхронизаций Ozon</h1>
          ...
          <Pagination
            ...
            basePath="/admin/ozon/sync-history"

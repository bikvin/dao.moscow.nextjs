/*
  ...
  - The values [FULFILLED] on the enum `OrderStatusEnum` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "OrderStatusEnum_new" AS ENUM ('RESERVE', 'SHIPMENT_PLANNED', 'DELIVERED', 'CANCELLED');
